...
in
rec {
  toNoHashTagAttrs = attrs: builtins.mapAttrs(color: value: builtins.replaceStrings ["#"] [""] value) attrs;
  toRGBStringAttrs = attrs: builtins.mapAttrs(color: value: toRGBString value) (toNoHashTagAttrs attrs);
  toRGBAStringAttrs = attrs: builtins.mapAttrs(color: value: toRGBAString value) (toNoHashTagAttrs attrs);
  ...
  # toRGBAString: str -> str
  toRGBAString = s: 
      if (builtins.stringLength s) != 6
      then throw "invalid hex color code"
      else lib.concatStrings [
        "rgba(${builtins.toString (fromHexString (builtins.substring 0 2 s))},"
        "${builtins.toString (fromHexString (builtins.substring 2 2 s))},"
        "${builtins.toString (fromHexString (builtins.substring 4 2 s))},"
        "${builtins.toString cfg.alpha})"
      ];
